...
class setting_config:
    ...
    data_path = os.path.join(project_root, "data", "train_npz")
    datasets = Synapse_dataset
    list_dir = os.path.join(project_root, "data", "lists", "lists_wmh")
    volume_path = os.path.join(project_root, "data", "test_vol_h5")
